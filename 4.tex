...
\begin{center} % copied from 3.tex! {
\begin{tabular}{ | l l l : l l l : l l l | }
	...
	\hline
	\multicolumn{3}{|c }{V} &
	\multicolumn{3}{ c }{II-Major} &
	\multicolumn{3}{ c|}{I-Major}\\
	\hline
\end{tabular}
\end{center} % } copied from 3.tex!
...
\begin{itemize}
  \item Avoid double flats:
      respell as simplest enharmonic equivalent
      i.e., Bbb should become A
  \item Avoid Fb and Cb
      respell Fb as E
      respell Cb as B
  \item In situations where you have creative choice,
...
\begin[staffsize=25]{lilypond}
\layout { ragged-right = ##f } % stretch horizontally
\relative c' {
  \override TextScript #'extra-offset = #'(2 . 4)
  <c ees ges a>1-\markup { \tiny \pad-markup #0.65 "root, 3rd, 5th, 7th" }
}
\end{lilypond}
