...
\end{tabular}
\end{center}
% TODO: use superscript and subscript?
...
\end{tabular}
\end{center}%TODO use something other than UPPER-CASE LETTERS?
...
\begin{tabular}{ l l l }
  ...
  !       & not present in structure &
      !6 (sixths are not present)\\ %in the structure being discussed
\end{tabular}
\end{center}
